...
export function LubricantManagement({ data, update }) {
  ...
  const bill= c => {
    ...
    try {
      // Use a data URL instead of document.write. This avoids blank about:blank
      // windows on browsers that block/interrupt document.write in a new tab.
      const billUrl = "data:text/html;charset=utf-8," + encodeURIComponent(html);
      w.location.replace(billUrl);
