...
function App() {
  ...
  useEffect(() => {
    ...
    catch (error) { console.error("StationMitra local cache persistence failed:", error); }
    ...
    cloudSaveTimerRef.current = setTimeout(async () => {
      try {
        ...
        console.error("StationMitra cloud save failed:", error);
...
.nav {
  ...
  if (!authReady) { return <div style={{padding:40,fontFamily:"sans-serif"}}>StationMitra शुरू हो रहा है…</div>; }
      ...
      <>
        ...
        <div className="login-page">
          <form className="login-card" onSubmit={async e => {
            ...
            <div className="login-brand">⛽ StationMitra</div>
